...
/**
 * Api services for the `HumanInteraction` model.
 */
@Injectable()
export class HumanInteractionApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for HumanInteraction registers.
   *
   ...
   * <em>
   * (The remote method definition does not provide any description.
   * This usually means the response is a `HumanInteraction` object.)
   * </em>
   */
  public stats(range: any, custom: any = {}, where: any = {}, groupBy: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/HumanInteractions/stats";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
