...
/**
 * Api services for the `AIInteraction` model.
 */
@Injectable()
export class AIInteractionApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for AIInteraction registers.
   *
   ...
   * <em>
   * (The remote method definition does not provide any description.
   * This usually means the response is a `AIInteraction` object.)
   * </em>
   */
  public stats(range: any, custom: any = {}, where: any = {}, groupBy: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AIInteractions/stats";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
