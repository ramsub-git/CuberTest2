...
/**
 * Api services for the `Office` model.
 */
@Injectable()
export class OfficeApi extends BaseLoopBackApi {
   ...
   */
  public humanSaid(text: any = {}): Observable<any> {
  ...
  /**
   * Statistical information for Office registers.
   *
